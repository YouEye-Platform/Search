...
/**
 * Compact search bar rendered inside the AppHeader.
 * Only visible on the /search results page.
 */
export function HeaderSearchBar() {
  ...
  // Sync query when URL changes (e.g. clicking a related search)
  useEffect(() => {
  ...
  const navigate = useCallback(
    (q: string) => {
      ...
      if (currentCategory && currentCategory !== "general" && currentCategory !== "search") {
